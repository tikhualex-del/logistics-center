...
-- CreateTable
CREATE TABLE "IntegrationInboundLog" (
    "id" TEXT NOT NULL,
    ...
    "errorMessage" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "IntegrationInboundLog_pkey" PRIMARY KEY ("id")
);
-- CreateTable
...
-- CreateIndex
CREATE UNIQUE INDEX "RouteOrder_orderId_key" ON "RouteOrder"("orderId");
-- CreateIndex
CREATE INDEX "RouteOrder_routeId_idx" ON "RouteOrder"("routeId");
-- CreateIndex
CREATE UNIQUE INDEX "RouteOrder_routeId_sequence_key" ON "RouteOrder"("routeId", "sequence");
-- CreateIndex
CREATE INDEX "IntegrationInboundLog_integrationId_createdAt_idx" ON "IntegrationInboundLog"("integrationId", "createdAt");
-- CreateIndex
CREATE INDEX "IntegrationInboundLog_orderId_idx" ON "IntegrationInboundLog"("orderId");
-- CreateIndex
CREATE INDEX "IntegrationInboundLog_companyId_createdAt_idx" ON "IntegrationInboundLog"("companyId", "createdAt");
-- CreateIndex

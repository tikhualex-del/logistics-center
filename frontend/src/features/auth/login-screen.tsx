...
const featureHighlights = [
  {
    title: 'Операции в одном контуре',
    description:
      'Карта, курьеры, маршруты и алерты собираются в один диспетчерский ритм.',
    icon: MapPinned,
  },
  {
    title: 'Сигналы без задержки',
    description:
      'Realtime-события и статусы заказа сразу попадают в рабочее поле диспетчера.',
    icon: RadioTower,
  },
  {
    title: 'Tenant-safe доступ',
    description:
      'Сессия и данные изолированы по компании и роли уже на уровне платформы.',
    icon: ShieldCheck,
  },
] as const

const shiftChecklist = [
  'Доступ к диспетчерскому рабочему полю',
  'Переход к задачам маршрутизации и контроля заказов',
        ...
        <section className="hidden px-8 py-10 lg:flex lg:flex-col lg:justify-between xl:px-14">
          <div className="max-w-2xl">
            ...
            <div className="mt-10 space-y-6">
              ...
              >
                Вход в смену, где карта управляет каждым движением.
              </h1>
              <p className="max-w-xl text-base leading-7 text-slate-600 xl:text-lg">
                Экран входа собран как диспетчерская стойка: без визуального шума,
                но с ощущением живой операционной среды. Следующий шаг после логина
                - рабочее поле маршрутов и заказов.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(255,250,244,0.84))] p-6 shadow-[0_28px_80px_rgba(94,63,44,0.18)] backdrop-blur xl:p-8">
              <div className="flex items-start justify-between gap-6">
                <div>
                  ...
                  >
                    Войти в Logistics Center
                  </h2>
                  <p className="mt-4 max-w-md text-sm leading-6 text-slate-600">
                    Войдите в рабочее пространство диспетчера. Сессия защищена
                    JWT с автоматическим обновлением токена в фоне.
                  </p>
                </div>
              ...
              >
                <div className="space-y-2">
                  ...
                  {errors.email ? (
                    ...
                    <p className="text-sm text-slate-500">
                      Логин совпадает с email сотрудника в системе компании.
                    </p>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-3 pt-3 sm:flex-row">
                  <Button
                    ...
                    className="h-12 flex-1 rounded-full bg-slate-950 text-[#f3ebde] hover:bg-slate-800"
                  >
                    {loginMutation.isPending ? 'Открываем смену...' : 'Войти в диспетчерскую'}

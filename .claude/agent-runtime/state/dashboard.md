...
| FEAT-006 | phase-0-finalize-fix-reviewer-blockers | в работе | frontend-разработчик | v1 | ожидает | — | продолжить: frontend-разработчик |
...
| ★ | FEAT-006 | frontend-разработчик | в работе | v1 | ожидает |
